...
export const TWELVE_DI_YIN: DiYin[] = [
  ...
  { index: 2, name: '三音', xiang: '水', huFa: '开', qingZhuo: '清', chars: '川于一百' },
  ...
  { index: 8, name: '九音', xiang: '土', huFa: '收', qingZhuo: '清', chars: '女语如鼠居' },
  { index: 9, name: '十音', xiang: '石', huFa: '闭', qingZhuo: '浊', chars: '乌虎兔鸟主' },
  { index: 10, name: '十一音', xiang: '水', huFa: '开', qingZhuo: '清', chars: '内年牛泥女' },
