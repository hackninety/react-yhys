 ...
 *   两法在1984-2043甲子块内恰好重合（该块经卦=世卦=鼎，2026均为同人）；
 *   分歧在其他甲子块显现——黄畿随各块世卦重新锚定，祝泌保持60年固定周期。
 *   例：1924甲子 黄畿=巽（经卦为姤四变巽）/祝泌=鼎；2044甲子 黄畿=大过/祝泌=鼎。
 *
...
export const zhubiAlgorithm: HexagramAlgorithm = {
  ...
  getSuiHexagram(gregorianYear: number): Hexagram64 {
     ...
     *
     * 与黄畿挨六十卦次法的区别：
     * - 黄畿：每60年块从当块世卦位置重新起算（2044甲子=大过）
     * - 祝泌：始终从1984世卦「鼎」位置按60年周期平推（2044甲子=鼎）
     */
    // 找到甲子年（1984）所在世的世卦
